...
test("cleaning and final proof controls are paired", () => { for (const label of ["Refill proof", "Cleaning and final check", "I have completed all checks:", "Machine exterior is clean", "Machine is operating properly", "Cancel"]) hasPair(stop, label); });
...
test("separate cash workflow guidance and stop notes remain bilingual", () => {
  hasPair(stop, "Cash is recorded separately");
