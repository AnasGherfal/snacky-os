...
test("standalone money page is localized and not a route form",()=>{assert.match(moneyPage,/OperatorMoneyLedgerClient/);assert.match(moneyPage,/locale=\{locale\}/);assert.match(moneyPage,/selfServiceOnly/);assert.match(ui,/locale===\"ar\"/);assert.match(ui,/dir=\{ar\?\"rtl\":\"ltr\"\}/);});
