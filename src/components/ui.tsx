...
function statusTone(status: string | null | undefined) {
  ...
  const warn = ["review", "pending", "draft", "assigned", "in_progress", "maintenance", "low_stock", "reserved", "partial", "unpaid", "missing", "disputed"];
  const ok = ["active", "confirmed", "completed", "paid", "received", "available", "resolved", "reviewed", "verified", "counted_confirmed", "included", "ok", "complete"];
