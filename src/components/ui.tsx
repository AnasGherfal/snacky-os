...
function statusTone(status: string | null | undefined) {
  ...
  const warn = ["review", "pending", "draft", "assigned", "in_progress", "maintenance", "low_stock", "reserved", "partial", "unpaid", "missing", "disputed", "contacted", "meeting_needed", "offer_sent", "follow_up_later", "want_to_contact"];
