...
export const ErrorState = ({ title, body, action }: { title: string; body: string; action?: ReactNode }) => <div className="surface-card border-rose-200 bg-rose-50 text-center"><h3 className="text-base font-semibold text-rose-900">{title}</h3><p className="mt-2 text-sm text-rose-700">{body}</p>{action ? <div className="mt-4">{action}</div> : null}</div>;
