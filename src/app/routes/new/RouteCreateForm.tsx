...
function ProductThumb({ product }: { product?: ProductPickOption }) {
  const initials = (product?.name ?? "?").slice(0, 2).toUpperCase();
  return <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-md bg-slate-100 text-xs font-semibold text-slate-500">{initials}</div>;
}
