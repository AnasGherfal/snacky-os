...
export function productCost(row: any) {
  const cost = numberValue(
    row.product?.average_cost_lyd ??
      row.products?.average_cost_lyd ??
      row.product?.last_purchase_cost_lyd ??
      row.products?.last_purchase_cost_lyd ??
      row.product?.current_cost_price_lyd ??
      row.products?.current_cost_price_lyd ??
