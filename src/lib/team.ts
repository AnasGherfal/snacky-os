...
export const roleDescriptions: Record<AppRole, string> = {
  ...
  crm: "Customer Relations & Business Development — My Work, leads, visits, contacts, customer issues and assigned location/rent follow-ups. No owner balances, payroll, inventory editing or system permissions.",
