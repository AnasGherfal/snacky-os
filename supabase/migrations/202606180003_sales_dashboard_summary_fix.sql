...
as $$
  ...
  select
    ...
    aggregated.successful_units_sold as units_sold,
    case
    ...
    case
      when aggregated.total_attempt_count > 0
        then (aggregated.failed_vend_count::numeric / aggregated.total_attempt_count::numeric)::numeric(12,4)
      else 0::numeric(12,4)
    end as failed_vend_rate,
    aggregated.cash_payment_amount as cash_sales_amount,
    aggregated.card_payment_amount as card_sales_amount,
    aggregated.unknown_payment_amount as unknown_payment_sales_amount,
