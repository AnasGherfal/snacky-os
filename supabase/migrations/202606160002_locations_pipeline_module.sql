-- Lightweight CRM pipeline for potential machine locations before activation.
...
begin
  if exists (
    ...
    where table_schema = 'public'
      and table_name = 'location_pipeline_leads'
...
do $$
begin
  if to_regclass('public.location_pipeline_leads') is not null then
